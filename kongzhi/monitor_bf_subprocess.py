...
def run_cmd(cmd, script_name, folder_path):
    try:
...
def run_main_mdocr(folder_path):
    ...
    return run_cmd(cmd, script_name, folder_path)
...
def run_md_llm_api(folder_path, polish_type, model_type):
    ...
    cmd = [
        sys.executable, md_llm_api_path,
