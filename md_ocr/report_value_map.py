...
REPORT_VALUE_FILTER_MAP = {
    ...
    16: {
        ...
        3: {"remove_chars": COMMON_REMOVE_CHARS},  # 血红蛋白A(Hb A)
        4: {"remove_chars": COMMON_REMOVE_CHARS},  # 血红蛋白A2(Hb A2)
    },
...
REPORT_VALUE_MAP = {
    ...
    16: {
        ...
        3: [ZERO_TO_NULL_RULE, TEXT_PLACEHOLDER_RULE],  # 血红蛋白A(Hb A)
        4: [ZERO_TO_NULL_RULE, TEXT_PLACEHOLDER_RULE],  # 血红蛋白A2(Hb A2)
    },
...
REPORT_VALUE_KEEP_MAP = {
    ...
    16: {
        ...
        3: {"keep_contains": COMMON_KEEP_KEYWORDS},  # 血红蛋白A(Hb A)
        4: {"keep_contains": COMMON_KEEP_KEYWORDS},  # 血红蛋白A2(Hb A2)
    },
