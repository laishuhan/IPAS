...
infectious_disease_report = General_Report(
    ...
    keywords = [
        ...
        ["丙肝抗体(Anti-HCV)", "丙肝抗体", "Anti-HCV", "HCV","AntiHCV","丙型肝炎病毒抗体","丙型肝炎病毒抗体(化学发光法)"],
        ["艾滋抗体(Anti-HIV)", "艾滋抗体", "Anti-HIV", "HIV","AntiHIV","HIV抗原抗体","HIV(Ag/Ab)","人类免疫缺陷病毒抗原抗体","HIV抗原抗体(化学发光法)"],
...
thalassemia_report = General_Report(
    ...
    keywords=[
        ...
        ["血红蛋白A(Hb A)", "Hb A", "HBA", "HbA", "血红蛋白A"],
        ["血红蛋白A2(Hb A2)", "Hb A2", "HBA2", "HbA2", "血红蛋白A2"],
    ],
    unit_conversions=[
        [],
        [],
